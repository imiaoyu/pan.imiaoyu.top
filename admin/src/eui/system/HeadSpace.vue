<template>
  ...
  <div>
    ...
    <el-dropdown
      trigger="click"
      style="font-size:100%;float:right;margin-right:10px"
    >
    ...
    <Message id="right" />
    <i class="el-icon-full-screen" id="right" @click="change_full_screen()" />
  </div>
</template>
<script>
import SettingSpace from "@/eui/system/unit/SettingSpace";
import Message from "@/eui/system/unit/Message";
export default {
  components: {
    SettingSpace,
    Message
