    ...
    <el-card shadow="never">
      ...
      <div style="min-height:60vh">
        <row :gutter="16">
          <el-col :xs="24" :lg="18">
            <el-form size="small" ref="form" :model="form" label-width="130px">
              ...
              <el-form-item label="SSL端口号">
                <el-input-number v-model="form.email_port_code" @change="handleChange" :min="1" :max="1000"
                  label="描述文字"></el-input-number>qq邮箱的ssl协议方式端口号是465/587
              </el-form-item>
          ...
          <el-col :xs="24" :lg="6" align="center">
            <i id="email" class="el-icon-message" title="邮件测试" @click="dialog_visible_state=true"></i>
            <el-dialog title="邮件发送测试" :visible.sync="dialog_visible_state" width="30%">
